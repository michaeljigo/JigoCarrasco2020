...
function runCRF(subj,eyetracking,practice)
...
[stimulus.taskParams, stimulus.stimParams, stimulus.eyeParams] = crfParams;
...
if practice
   ...
   myscreen.datadir = ['../data/pilot/crf/',subj,'/'];
end
...
if practice
   ...
   nBlocks = 15; % # of blocks needed to complete a full staircase for each condition
end
