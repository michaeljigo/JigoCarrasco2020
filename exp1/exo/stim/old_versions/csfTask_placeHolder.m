...
function csfTask_placeHolder(myscreen)
global stimulus
...
if myscreen.eyetracker.init && ~any(task.thistrial.thisseg==[1 2 7 8])
   ...
   if stimulus.eyeParams.breakCounter>=stimulus.eyeParams.frames2Break
      ...
      mglClearScreen; drawFixAndPlaceholders; drawOccluders(myscreen)
      mglTextDraw('Do not move your eyes from the X',[0 0]);
      mglFlush; mglClearScreen; drawFixAndPlaceholders; drawOccluders(myscreen)
