...
function runTask_v15(subj,session,eyetracking)
...
[stimulus.taskParams, stimulus.stimParams, stimulus.stairParams, stimulus.eyeParams] = ...
    initParams_v15(session);

if ~session
    % generate/load staircases
    [stimulus.stair, stimulus.stairInfo] = initStair_v15(subj,stimulus.taskParams,stimulus.stairParams);
